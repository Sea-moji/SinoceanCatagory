#
#  Be sure to run `pod spec lint sinoceanCatagory.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "Sea-moji"
  # spec.authors            = { "Sea-moji" => "zwcsssapple@163.com" }
  # spec.social_media_url   = "https://twitter.com/Sea-moji"
